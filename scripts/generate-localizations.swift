...
private let appEntries: [Entry] = [
    ...
    Entry("Calendar Sync", "日历同步", "行事曆同步", "カレンダー同期", "캘린더 동기화", "Calendar Sync", "Calendar Sync", "Calendar Sync", "Calendar Sync", "Calendar Sync", "Calendar Sync"),
    Entry("Calendar access is required for automatic sync", "自动同步需要日历权限", "自動同步需要行事曆權限", "自動同期にはカレンダー権限が必要です", "자동 동기화에는 캘린더 권한이 필요합니다", "Calendar access is required for automatic sync", "Calendar access is required for automatic sync", "Calendar access is required for automatic sync", "Calendar access is required for automatic sync", "Calendar access is required for automatic sync", "Calendar access is required for automatic sync"),
    Entry("Keep Important Days in Calendar", "在日历中保留重要日", "在行事曆中保留重要日", "大切な日をカレンダーに保存", "캘린더에 소중한 날 보관", "Keep Important Days in Calendar", "Keep Important Days in Calendar", "Keep Important Days in Calendar", "Keep Important Days in Calendar", "Keep Important Days in Calendar", "Keep Important Days in Calendar"),
    Entry("Taisetsu can automatically keep your important days in a dedicated Calendar. You can change the scope later in Settings.", "Taisetsu 可自动将重要日保存在专用日历中。你可以稍后在设置中修改范围。", "Taisetsu 可自動將重要日保存在專用行事曆中。你可以稍後在設定中修改範圍。", "Taisetsuは大切な日を専用カレンダーに自動保存します。範囲は後で設定から変更できます。", "Taisetsu는 소중한 날을 전용 캘린더에 자동으로 보관합니다. 범위는 설정에서 변경할 수 있습니다.", "Taisetsu can automatically keep your important days in a dedicated Calendar. You can change the scope later in Settings.", "Taisetsu can automatically keep your important days in a dedicated Calendar. You can change the scope later in Settings.", "Taisetsu can automatically keep your important days in a dedicated Calendar. You can change the scope later in Settings.", "Taisetsu can automatically keep your important days in a dedicated Calendar. You can change the scope later in Settings.", "Taisetsu can automatically keep your important days in a dedicated Calendar. You can change the scope later in Settings.", "Taisetsu can automatically keep your important days in a dedicated Calendar. You can change the scope later in Settings."),
    Entry("Enable Automatic Sync", "启用自动同步", "啟用自動同步", "自動同期を有効にする", "자동 동기화 활성화", "Enable Automatic Sync", "Enable Automatic Sync", "Enable Automatic Sync", "Enable Automatic Sync", "Enable Automatic Sync", "Enable Automatic Sync"),
    Entry("Remind Me Later", "稍后提醒", "稍後提醒", "後で通知", "나중에 알림", "Remind Me Later", "Remind Me Later", "Remind Me Later", "Remind Me Later", "Remind Me Later", "Remind Me Later"),
    Entry("Never Remind Again", "不再提醒", "不再提醒", "今後表示しない", "다시 알리지 않기", "Never Remind Again", "Never Remind Again", "Never Remind Again", "Never Remind Again", "Never Remind Again", "Never Remind Again"),
    Entry("Enabled", "已启用", "已啟用", "有効", "활성화됨", "Enabled", "Enabled", "Enabled", "Enabled", "Enabled", "Enabled"),
    Entry("Stopped", "已停止", "已停止", "停止中", "중지됨", "Stopped", "Stopped", "Stopped", "Stopped", "Stopped", "Stopped"),
    Entry("Managed Events", "托管事件", "管理事件", "管理中のイベント", "관리 이벤트", "Managed Events", "Managed Events", "Managed Events", "Managed Events", "Managed Events", "Managed Events"),
    Entry("Last Synced", "上次同步", "上次同步", "最終同期", "마지막 동기화", "Last Synced", "Last Synced", "Last Synced", "Last Synced", "Last Synced", "Last Synced"),
    Entry("Stop Automatic Sync", "停止自动同步", "停止自動同步", "自動同期を停止", "자동 동기화 중지", "Stop Automatic Sync", "Stop Automatic Sync", "Stop Automatic Sync", "Stop Automatic Sync", "Stop Automatic Sync", "Stop Automatic Sync"),
    Entry("Sync Range", "同步范围", "同步範圍", "同期範囲", "동기화 범위", "Sync Range", "Sync Range", "Sync Range", "Sync Range", "Sync Range", "Sync Range"),
    Entry("Automatic Calendar Sync", "自动日历同步", "自動行事曆同步", "自動カレンダー同期", "자동 캘린더 동기화", "Automatic Calendar Sync", "Automatic Calendar Sync", "Automatic Calendar Sync", "Automatic Calendar Sync", "Automatic Calendar Sync", "Automatic Calendar Sync"),
    Entry("This important day is managed automatically in the Taisetsu calendar.", "这个重要日会自动在 Taisetsu 日历中管理。", "這個重要日會自動在 Taisetsu 行事曆中管理。", "この大切な日はTaisetsuカレンダーで自動管理されます。", "이 소중한 날은 Taisetsu 캘린더에서 자동으로 관리됩니다.", "This important day is managed automatically in the Taisetsu calendar.", "This important day is managed automatically in the Taisetsu calendar.", "This important day is managed automatically in the Taisetsu calendar.", "This important day is managed automatically in the Taisetsu calendar.", "This important day is managed automatically in the Taisetsu calendar.", "This important day is managed automatically in the Taisetsu calendar."),
    Entry("Sync Now", "立即同步", "立即同步", "今すぐ同期", "지금 동기화", "Sync Now", "Sync Now", "Sync Now", "Sync Now", "Sync Now", "Sync Now"),
    Entry("Sync requested", "已请求同步", "已要求同步", "同期をリクエストしました", "동기화를 요청했습니다", "Sync requested", "Sync requested", "Sync requested", "Sync requested", "Sync requested", "Sync requested"),
    Entry("All future occurrences in this rolling window are managed automatically.", "滚动范围内的所有未来日期都会自动管理。", "滾動範圍內的所有未來日期都會自動管理。", "このローリング期間内の将来の日付は自動管理されます。", "이 롤링 기간의 모든 향후 날짜는 자동으로 관리됩니다.", "All future occurrences in this rolling window are managed automatically.", "All future occurrences in this rolling window are managed automatically.", "All future occurrences in this rolling window are managed automatically.", "All future occurrences in this rolling window are managed automatically.", "All future occurrences in this rolling window are managed automatically.", "All future occurrences in this rolling window are managed automatically."),
    Entry(
...
private let infoPlistEntries: [Entry] = [
    ...
    Entry(
        ...
        "用于自动将重要日同步到专用系统日历。",
        "用於自動將重要日同步至專用系統行事曆。",
        "大切な日を専用のシステムカレンダーに自動同期するために使用します。",
        "소중한 날을 전용 시스템 캘린더에 자동으로 동기화하는 데 사용합니다.",
        "Permite sincronizar automáticamente las fechas importantes con un calendario dedicado.",
        "Permet de synchroniser automatiquement les dates importantes avec un calendrier dédié.",
        "Ermöglicht die automatische Synchronisierung wichtiger Tage mit einem eigenen Kalender.",
        "Permite sincronizar automaticamente datas importantes com um Calendário dedicado.",
        "Consente di sincronizzare automaticamente i giorni importanti con un Calendario dedicato.",
        "يتيح مزامنة الأيام المهمة تلقائيًا مع تقويم مخصص."
    )
]
